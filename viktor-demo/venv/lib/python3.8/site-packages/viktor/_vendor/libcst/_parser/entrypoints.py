...
from viktor._vendor.libcst._nodes.base import CSTNode
from viktor._vendor.libcst._nodes.expression import BaseExpression
from viktor._vendor.libcst._nodes.module import Module
from viktor._vendor.libcst._nodes.statement import BaseCompoundStatement, SimpleStatementLine
from viktor._vendor.libcst._parser.detect_config import convert_to_utf8, detect_config
from viktor._vendor.libcst._parser.grammar import get_grammar, validate_grammar
from viktor._vendor.libcst._parser.python_parser import PythonCSTParser
from viktor._vendor.libcst._parser.types.config import PartialParserConfig
...
def _parse(
    ...
    *,
    ...
    if is_native():
        from viktor._vendor.libcst.native import parse_expression, parse_module, parse_statement
