...
## Welcome to the VIKTOR demo app!
...
A simple parametrization can be created using fields only. However, if the parametrization becomes large, a layered structure can be
achieved by making use of [Tab(s)](https://docs.viktor.ai/docs/create-apps/layout-and-styling/tabs-and-sections),
[Page(s)](https://docs.viktor.ai/docs/create-apps/layout-and-styling/pages), or 
[Step(s)](https://docs.viktor.ai/docs/create-apps/layout-and-styling/steps) (used in this demo). 
...
in the source code of this demo app.
""")
...
Have a look at this demo's source code by opening it in your favorite
